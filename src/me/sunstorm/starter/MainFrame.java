...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(
                MainFrame.class.getResource("/com/sun/javafx/scene/control/skin/modena/HTMLEditor-Bold-Black@2x.png")));
        ...
        Image img = (new ImageIcon(MainFrame.class.getResource("/me/sunstorm/starter/icon.png"))).getImage()
        ...
        File save = new File(System.getProperty("user.home") + File.separator + "AppData" + File.separator + "Roaming"
                + File.separator + "Build" + File.separator + "save.cfg");
        if (save.exists()) {
            try {
        ...
        btnStart.addActionListener(e -> {
            ...
            /*
             * System.out.
             * println("Entering the cycle of death powered by the evil OutOfMemoryError, feat: Jave heap space"
             * ); int length = arguments.length(); for (int i = 0; i < length; i++) { char c
             * = arguments.charAt(i); System.out.println(c); if (c == '-' && i != 0) { if
             * (arguments.charAt(i-1) == '-' && i != 1) { arguments.insert(i -1, " "); }
             * else { arguments.insert(i, " "); } } }
             */
            ...
            {// scope for visibility
                ...
                if (!b.exists() || !g.exists()) {
                    JOptionPane.showMessageDialog(null, "The specified directory not exist!", "BuildTools Starter",
            ...
            File launcher = new File(System.getProperty("user.home") + File.separator + "AppData" + File.separator
                    + "Roaming" + File.separator + "Build" + File.separator + "starter.bat");
            try {
                launcher.getParentFile().mkdirs();
                launcher.createNewFile();
                BufferedWriter writer2 = new BufferedWriter(new FileWriter(launcher));
                writer2.write(bashDir + " --login -i -c \"java -jar " + buildDir + " --rev " + version + " "
            ...
            try {
                System.out.println("started process: " + bashDir + " --login -i -c \"java -jar " + buildDir + " --rev "
                        + version + " " + arguments.toString() + "\"" + "\n");
